...
srun python convert_ckpt_to_pth.py /purestorage/AILAB/AI_2/yjhwang/work/reid/torch-solider/important_checkpoints/phase2/solider-epoch=09-train_loss=0.69.ckpt -o phase2.pth