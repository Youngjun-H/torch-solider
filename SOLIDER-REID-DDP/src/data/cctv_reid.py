...
class CCTVReID(BaseImageDataset):
    ...
    Note: root should be the full path to cctv_reid_dataset_v2 directory
    Example: root='/purestorage/AILAB/AI_2/datasets/PersonReID/cctv_reid_dataset_v2'
    """
    dataset_dir = ''  # Empty because root already contains full path

    def __init__(self, root='', verbose=True, pid_begin=0, **kwargs):
        super(CCTVReID, self).__init__()
        # root already contains the full path to cctv_reid_dataset_v2
